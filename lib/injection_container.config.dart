...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i250.AuthRepository>(
      () => _i30.AuthRepositoryImpl(
        gh<_i59.FirebaseAuth>(),
        gh<_i974.FirebaseFirestore>(),
      ),
    );
    gh.lazySingleton<_i867.DiaryRepository>(
      () => _i206.DiaryRepositoryImpl(
        gh<_i974.FirebaseFirestore>(),
    ...
    gh.lazySingleton<_i128.NotificationService>(
      () => _i128.NotificationService(
    ...
    gh.lazySingleton<_i236.ProjectRepository>(
      () => _i311.ProjectRepositoryImpl(
        gh<_i974.FirebaseFirestore>(),
        gh<_i59.FirebaseAuth>(),
      ),
    );
    ...
    gh.factory<_i677.MoveToShoppingUseCase>(
      () => _i677.MoveToShoppingUseCase(
        gh<_i911.ShoppingRepository>(),
        gh<_i706.Uuid>(),
      ),
    );
    gh.factory<_i290.GenerateAlertsUseCase>(
      () => _i290.GenerateAlertsUseCase(
    ...
    gh.factory<_i307.DocumentsCubit>(
      () => _i307.DocumentsCubit(
    ...
    gh.factory<_i420.GetHomeDataUseCase>(
      () => _i420.GetHomeDataUseCase(
        gh<_i250.AuthRepository>(),
        gh<_i236.ProjectRepository>(),
        gh<_i974.FirebaseFirestore>(),
      ),
    );
    gh.factory<_i183.CompareQuotesUseCase>(
      () => _i183.CompareQuotesUseCase(
        gh<_i1001.SupplierRepository>(),
        gh<_i180.SinapiService>(),
      ),
    );
    gh.factory<_i560.HomeCubit>(
      () => _i560.HomeCubit(
        gh<_i420.GetHomeDataUseCase>(),
        gh<_i290.GenerateAlertsUseCase>(),
      ),
    );
    gh.factory<_i826.AcceptQuoteUseCase>(
      () => _i826.AcceptQuoteUseCase(
        gh<_i1001.SupplierRepository>(),
    ...
    gh.lazySingleton<_i865.CreateShoppingPurchaseUseCase>(
      () => _i865.CreateShoppingPurchaseUseCase(
        gh<_i356.TransactionRepository>(),
      ),
    );
    ...
    gh.factory<_i1073.ProjectsListCubit>(
      () => _i1073.ProjectsListCubit(
    ...
    gh.factory<_i476.PaymentsCubit>(
      () => _i476.PaymentsCubit(
        gh<_i984.PaymentRepository>(),
        gh<_i937.MarkPaymentAsPaidUseCase>(),
      ),
    );
    gh.factory<_i916.OnboardingCubit>(
    ...
    gh.factory<_i734.AddInstallmentUseCase>(
      () => _i734.AddInstallmentUseCase(
    ...
    gh.factory<_i386.GlossaryCubit>(
      () => _i386.GlossaryCubit(
    ...
    gh.factory<_i1013.ShoppingCubit>(
      () => _i1013.ShoppingCubit(
    ...
    gh.factory<_i192.SuppliersCubit>(
      () => _i192.SuppliersCubit(
    ...
    gh.factory<_i45.ProjectCubit>(
      () => _i45.ProjectCubit(
        gh<_i627.GetProjectUsecase>(),
        gh<_i281.UpdateProjectUseCase>(),
      ),
    );
    gh.factory<_i224.InstallmentsCubit>(
      () => _i224.InstallmentsCubit(
    ...
    gh.factory<_i1061.FinancialCubit>(
      () => _i1061.FinancialCubit(
        gh<_i266.GetFinancialSummaryUseCase>(),
        gh<_i310.GetExpensesUseCase>(),
        gh<_i342.AddExpenseUseCase>(),
        gh<_i796.UpdateExpenseUseCase>(),
        gh<_i725.DeleteExpenseUseCase>(),
      ),
    );
    return this;
  }
