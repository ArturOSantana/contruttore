...
abstract class PhaseRepository {
  ...
  Future<Either<Failure, PhaseEntity>> getPhase(String phaseId);
  Future<Either<Failure, void>> updatePhase(PhaseEntity phase);
  Future<Either<Failure, void>> updateSubtask(
    String phaseId,
    SubtaskEntity subtask,
  );
  Future<Either<Failure, void>> completePhase(String phaseId);
  Future<Either<Failure, void>> startPhase(String phaseId);
}
